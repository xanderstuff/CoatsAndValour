...
import dev.sterner.common.component.GangreneComponent;
...
//    public static final ComponentKey<NationChunkComponent> NATION_CHUNK = ComponentRegistry.getOrCreate(CoatsAndValour.id("nation_chunk"), NationChunkComponent.class);
    ...
    public static final ComponentKey<GangreneComponent> GANGRENE = ComponentRegistry.getOrCreate(CoatsAndValour.id("gangrene"), GangreneComponent.class);


    @Override
    public void registerEntityComponentFactories(EntityComponentFactoryRegistry registry) {
        registry.registerFor(LivingEntity.class, BLEED, livingEntity -> new BleedComponent());
        registry.registerFor(LivingEntity.class, GANGRENE, livingEntity -> new GangreneComponent()); //TODO: perhaps only players should be able to have gangrene?
